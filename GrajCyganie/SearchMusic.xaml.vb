...
Public NotInheritable Class SearchMusic
    Inherits Page
    ...
    Private Async Sub uiSearch_Click(sender As Object, e As RoutedEventArgs)
        ...
        mLista = Await App.inVb.GetCurrentDb.SearchMusicAsync(uiArtist.Text, uiTitle.Text, uiAlbum.Text, uiRok.Text)
...
'        If SearchMusic.mPageWidth > 0 AndAlso SearchMusic.mPageWidth < 500 Then Return 0
